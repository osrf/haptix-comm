...
cmake -DCMAKE_PREFIX_PATH="..\ign-transport\build\install\%build_type%" -DPROTOBUF_SRC_ROOT_FOLDER="..\..\protobuf-2.6.0-win%build_bitness%-vc12" -DCPPZMQ_HEADER_PATH="..\cppzmq" -DZeroMQ_ROOT_DIR="..\ZeroMQ 3.2.4" -DBOOST_ROOT:STRING="%BOOST_PATH%" -DBOOST_LIBRARYDIR:STRING="%BOOST_LIBRARY_DIR%" -DMATLAB_ROOT:STRING="%MATLAB_PATH%" -DCMAKE_INSTALL_PREFIX="install/%build_type%" -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="%build_type%" .. 
